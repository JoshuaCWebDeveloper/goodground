...
echo "${PIHOLE_ADDRESS} goodmatrix.dyn.dnstools.be" > /etc/pihole/custom.list
echo "${PIHOLE_ADDRESS} goodelement.dyn.dnstools.be" >> /etc/pihole/custom.list
echo "${PIHOLE_ADDRESS} goodgun.dyn.dnstools.be" >> /etc/pihole/custom.list
echo "${PIHOLE_ADDRESS} goodiris.dyn.dnstools.be" >> /etc/pihole/custom.list